        ...
        switch (v.getId()) {
            ...
            case R.id.iv_share:
                ...
                try {
                    ...
                    String shareMessage = "\nHey!Check Out Video Editor With Music app is Professional Video Editing tool for your daily needs with most useful and handy Features to edit your video within minutes.!!!\n\n";
            ...
            case R.id.iv_privecy:
                ...
                i.setData(Uri.parse("https://karthikmittu12.blogspot.com/2021/02/privacy-policy.html"));
                startActivity(i);
                break;
